...
namespace PopLife.Customers.Services
{
    public static class CustomerEventBus
    {
        ...
        public static event Action<PopLife.Customers.Runtime.CustomerAgent> OnCustomerEnteredStore; // 顾客真正进入店内
        public static event Action<PopLife.Customers.Runtime.CustomerAgent> OnCustomerLeftStore; // 顾客真正离开店内
        ...
        public static void RaiseCustomerEnteredStore(PopLife.Customers.Runtime.CustomerAgent a) => OnCustomerEnteredStore?.Invoke(a);
        public static void RaiseCustomerLeftStore(PopLife.Customers.Runtime.CustomerAgent a) => OnCustomerLeftStore?.Invoke(a);
    }
}
